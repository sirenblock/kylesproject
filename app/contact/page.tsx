                ...
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <div className="text-slate-600">
                      <Link href="/service-areas#inlet-beach" className="text-ocean-600 hover:underline font-medium">Inlet Beach</Link> to <Link href="/service-areas#panama-city-beach" className="text-ocean-600 hover:underline font-medium">Panama City Beach</Link> along the scenic <a href="https://www.30aescapes.com/" target="_blank" rel="nofollow external noopener noreferrer" className="text-seafoam-600 hover:underline">30A corridor</a>. We proudly serve <Link href="/service-areas#rosemary-beach" className="text-ocean-600 hover:underline font-medium">Rosemary Beach</Link>, <Link href="/service-areas#alys-beach" className="text-ocean-600 hover:underline font-medium">Alys Beach</Link>, and all surrounding communities. Our eco-friendly disposal practices align with <a href="https://www.epa.gov/recycle" target="_blank" rel="nofollow external noopener noreferrer" className="text-seafoam-600 hover:underline">EPA recycling guidelines</a>.
                    </div>
                  </div>
                </div>
