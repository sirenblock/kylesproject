        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-6 text-xl text-slate-600">
              Ready to get rid of that junk? Whether you need <Link href="/services/furniture-removal" className="text-ocean-600 hover:underline font-medium">furniture removal</Link>, <Link href="/services/construction-debris" className="text-ocean-600 hover:underline font-medium">construction debris hauling</Link>, or <Link href="/services/estate-cleanout" className="text-ocean-600 hover:underline font-medium">estate cleanout services</Link>, we're here to help. Serving communities from <Link href="/service-areas/seaside" className="text-ocean-600 hover:underline font-medium">Seaside</Link> to <Link href="/service-areas/panama-city-beach" className="text-ocean-600 hover:underline font-medium">Panama City Beach</Link>, get in touch and we'll help you out.
            </p>
          </div>
        </div>
      </section>
