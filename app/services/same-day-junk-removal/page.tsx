...
const service = getServiceDetail('same-day-junk-removal')!
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getCanonicalUrl('/services/same-day-junk-removal')
  },
  openGraph: {
    title: `${service.title}`,
...
export default function ServicePage() {
  const internalLinks = getContextualLinks('service', '/services/same-day-junk-removal')
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ServiceSchema
        name={service.title}
        description={service.description}
        url="/services/same-day-junk-removal"
      />
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href={getSMSLink(PHONE_NUMBER, `Hi, I need same-day junk removal`)}
      ...
      <AllServicesGrid currentSlug="same-day-junk-removal" />

      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('same-day-junk-removal')}
        locations={getRelatedLocationsForService('same-day-junk-removal')}
        blogPosts={getRelatedBlogPostsForService('same-day-junk-removal')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('same-day-junk-removal')}
