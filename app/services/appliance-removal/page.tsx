...
const service = getServiceDetail('appliance-removal')!

export const metadata: Metadata = {
  title: `${service.title} | 30A Junk Removal | Same-Day Service`,
  description: service.description,
  alternates: {
    canonical: getCanonicalUrl('/services/appliance-removal')
  },
  openGraph: {
...
export default function ServicePage() {
  const internalLinks = getContextualLinks('service', '/services/appliance-removal')
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('appliance-removal')}
        locations={getRelatedLocationsForService('appliance-removal')}
        blogPosts={getRelatedBlogPostsForService('appliance-removal')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('appliance-removal')}
