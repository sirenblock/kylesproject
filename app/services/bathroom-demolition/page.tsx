...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getCanonicalUrl('/services/bathroom-demolition')
  },
  openGraph: {
    title: `${service.title}`,
...
export default function ServicePage() {
  const internalLinks = getContextualLinks('service', '/services/bathroom-demolition')
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ServiceSchema
        name={service.title}
        description={service.description}
        url="/services/bathroom-demolition"
      />
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href={getSMSLink(PHONE_NUMBER, `Hi, I need a quote for bathroom demolition`)}
      ...
      <AllServicesGrid currentSlug="bathroom-demolition" />

      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('bathroom-demolition')}
        locations={getRelatedLocationsForService('bathroom-demolition')}
        blogPosts={getRelatedBlogPostsForService('bathroom-demolition')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('bathroom-demolition')}
