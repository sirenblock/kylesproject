...
const service = getServiceDetail('bulk-trash-pickup')!
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getCanonicalUrl('/services/bulk-trash-pickup')
  },
  openGraph: {
    title: `${service.title}`,
...
export default function ServicePage() {
  ...
  const internalLinks = getContextualLinks('service', '/services/bulk-trash-pickup')
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ServiceSchema
        name={service.title}
        description={service.description}
        url="/services/bulk-trash-pickup"
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href={getSMSLink(PHONE_NUMBER, `Hi, I need a quote for bulk trash pickup`)}
      ...
      <AllServicesGrid currentSlug="bulk-trash-pickup" />

      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('bulk-trash-pickup')}
        locations={getRelatedLocationsForService('bulk-trash-pickup')}
        blogPosts={getRelatedBlogPostsForService('bulk-trash-pickup')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('bulk-trash-pickup')}
