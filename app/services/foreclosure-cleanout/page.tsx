...
const service = getServiceDetail('foreclosure-cleanout')!
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getCanonicalUrl('/services/foreclosure-cleanout')
  },
  openGraph: {
    title: `${service.title}`,
...
export default function ServicePage() {
  const internalLinks = getContextualLinks('service', '/services/foreclosure-cleanout')
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ServiceSchema
        name={service.title}
        description={service.description}
        url="/services/foreclosure-cleanout"
      />
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href={getSMSLink(PHONE_NUMBER, `Hi, I need a quote for foreclosure cleanout`)}
      ...
      <AllServicesGrid currentSlug="foreclosure-cleanout" />

      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('foreclosure-cleanout')}
        locations={getRelatedLocationsForService('foreclosure-cleanout')}
        blogPosts={getRelatedBlogPostsForService('foreclosure-cleanout')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('foreclosure-cleanout')}
