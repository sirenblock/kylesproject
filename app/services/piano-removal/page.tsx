...
const service = getServiceDetail('piano-removal')!
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getCanonicalUrl('/services/piano-removal')
  },
  openGraph: {
    title: `${service.title}`,
...
export default function ServicePage() {
  const internalLinks = getContextualLinks('service', '/services/piano-removal')
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href={getSMSLink(PHONE_NUMBER, `Hi, I need a quote for piano removal`)}
      ...
      <AllServicesGrid currentSlug="piano-removal" />

      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('piano-removal')}
        locations={getRelatedLocationsForService('piano-removal')}
        blogPosts={getRelatedBlogPostsForService('piano-removal')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('piano-removal')}
