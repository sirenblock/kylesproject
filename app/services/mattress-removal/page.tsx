...
export default function ServicePage() {
  ...
  const internalLinks = getContextualLinks('service', '/services/mattress-removal')
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href={getSMSLink(PHONE_NUMBER, `Hi, I need a quote for mattress removal`)}
      ...
      <AllServicesGrid currentSlug="mattress-removal" />

      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('mattress-removal')}
        locations={getRelatedLocationsForService('mattress-removal')}
        blogPosts={getRelatedBlogPostsForService('mattress-removal')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('mattress-removal')}
