...
const service = getServiceDetail('one-time-hauls')!

export const metadata: Metadata = {
  title: `${service.title} | 30A Junk Removal | Same-Day Service`,
  description: service.description,
  alternates: {
    canonical: getCanonicalUrl('/services/one-time-hauls')
  },
  openGraph: {
...
export default function ServicePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('one-time-hauls')}
        locations={getRelatedLocationsForService('one-time-hauls')}
        blogPosts={getRelatedBlogPostsForService('one-time-hauls')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('one-time-hauls')}
