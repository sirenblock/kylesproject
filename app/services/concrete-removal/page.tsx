...
const service = getServiceDetail('concrete-removal')!
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getCanonicalUrl('/services/concrete-removal')
  },
  openGraph: {
    title: `${service.title}`,
...
export default function ServicePage() {
  ...
  const internalLinks = getContextualLinks('service', '/services/concrete-removal')
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href={getSMSLink(PHONE_NUMBER, `Hi, I need a quote for concrete removal`)}
      ...
      <AllServicesGrid currentSlug="concrete-removal" />

      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('concrete-removal')}
        locations={getRelatedLocationsForService('concrete-removal')}
        blogPosts={getRelatedBlogPostsForService('concrete-removal')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('concrete-removal')}
