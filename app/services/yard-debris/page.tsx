...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getCanonicalUrl('/services/yard-debris')
  },
  openGraph: {
...
export default function ServicePage() {
  const internalLinks = getContextualLinks('service', '/services/yard-debris')
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('yard-debris')}
        locations={getRelatedLocationsForService('yard-debris')}
        blogPosts={getRelatedBlogPostsForService('yard-debris')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('yard-debris')}
