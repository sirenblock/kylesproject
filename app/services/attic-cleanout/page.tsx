...
const service = getServiceDetail('attic-cleanout')!
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getCanonicalUrl('/services/attic-cleanout')
  },
  openGraph: {
    title: `${service.title}`,
...
export default function ServicePage() {
  ...
  const internalLinks = getContextualLinks('service', '/services/attic-cleanout')
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href={getSMSLink(PHONE_NUMBER, `Hi, I need a quote for attic cleanout`)}
      ...
      <AllServicesGrid currentSlug="attic-cleanout" />

      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('attic-cleanout')}
        locations={getRelatedLocationsForService('attic-cleanout')}
        blogPosts={getRelatedBlogPostsForService('attic-cleanout')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('attic-cleanout')}
