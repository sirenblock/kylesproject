...
const service = getServiceDetail('donation-pickup')!

export const metadata: Metadata = {
  title: `${service.title} | 30A Junk Removal | Same-Day Service`,
  description: service.description,
  alternates: {
    canonical: getCanonicalUrl('/services/donation-pickup')
  },
  openGraph: {
...
export default function ServicePage() {
  const internalLinks = getContextualLinks('service', '/services/donation-pickup')
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('donation-pickup')}
        locations={getRelatedLocationsForService('donation-pickup')}
        blogPosts={getRelatedBlogPostsForService('donation-pickup')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('donation-pickup')}
