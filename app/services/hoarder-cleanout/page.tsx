...
const service = getServiceDetail('hoarder-cleanout')!
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getCanonicalUrl('/services/hoarder-cleanout')
  },
  openGraph: {
    title: `${service.title}`,
...
export default function ServicePage() {
  const internalLinks = getContextualLinks('service', '/services/hoarder-cleanout')
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href={getSMSLink(PHONE_NUMBER, `Hi, I need a quote for hoarding cleanup`)}
      ...
      <AllServicesGrid currentSlug="hoarder-cleanout" />

      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('hoarder-cleanout')}
        locations={getRelatedLocationsForService('hoarder-cleanout')}
        blogPosts={getRelatedBlogPostsForService('hoarder-cleanout')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('hoarder-cleanout')}
