...
const service = getServiceDetail('shed-demolition')!
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getCanonicalUrl('/services/shed-demolition')
  },
  openGraph: {
    title: `${service.title}`,
...
export default function ServicePage() {
  const internalLinks = getContextualLinks('service', '/services/shed-demolition')
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href={getSMSLink(PHONE_NUMBER, `Hi, I need a quote for shed demolition`)}
      ...
      <AllServicesGrid currentSlug="shed-demolition" />

      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('shed-demolition')}
        locations={getRelatedLocationsForService('shed-demolition')}
        blogPosts={getRelatedBlogPostsForService('shed-demolition')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('shed-demolition')}
