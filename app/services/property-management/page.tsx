...
const service = getServiceDetail('property-management')!

export const metadata: Metadata = {
  title: `${service.title} | 30A Junk Removal | Same-Day Service`,
  description: service.description,
  alternates: {
    canonical: getCanonicalUrl('/services/property-management')
  },
  openGraph: {
...
export default function ServicePage() {
  const internalLinks = getContextualLinks('service', '/services/property-management')
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('property-management')}
        locations={getRelatedLocationsForService('property-management')}
        blogPosts={getRelatedBlogPostsForService('property-management')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('property-management')}
