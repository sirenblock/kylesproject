...
const service = getServiceDetail('hurricane-debris')!
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getCanonicalUrl('/services/hurricane-debris')
  },
  openGraph: {
    title: `${service.title}`,
...
export default function ServicePage() {
  const internalLinks = getContextualLinks('service', '/services/hurricane-debris')
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href={getSMSLink(PHONE_NUMBER, `Hi, I need a quote for storm debris cleanup`)}
      ...
      <AllServicesGrid currentSlug="hurricane-debris" />

      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('hurricane-debris')}
        locations={getRelatedLocationsForService('hurricane-debris')}
        blogPosts={getRelatedBlogPostsForService('hurricane-debris')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('hurricane-debris')}
