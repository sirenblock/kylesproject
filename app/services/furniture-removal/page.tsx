...
const service = getServiceDetail('furniture-removal')!

export const metadata: Metadata = {
  title: `${service.title} | 30A Junk Removal | Same-Day Service`,
  description: service.description,
  alternates: {
    canonical: getCanonicalUrl('/services/furniture-removal')
  },
  openGraph: {
...
export default function ServicePage() {
  const internalLinks = getContextualLinks('service', '/services/furniture-removal')
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <section className="relative -mt-20 pt-32 pb-20 bg-gradient-to-br from-ocean-600 via-ocean-700 to-slate-800 text-white overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href={getSMSLink(PHONE_NUMBER, "Hi, I need a quote for furniture removal")}
      ...
      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('furniture-removal')}
        locations={getRelatedLocationsForService('furniture-removal')}
        blogPosts={getRelatedBlogPostsForService('furniture-removal')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('furniture-removal')}
        title="Helpful Resources for Furniture Disposal"
