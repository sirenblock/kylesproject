...
const service = getServiceDetail('commercial-junk-removal')!
...
export default function ServicePage() {
  const internalLinks = getContextualLinks('service', '/services/commercial-junk-removal')
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href={getSMSLink(PHONE_NUMBER, `Hi, I need a quote for commercial junk removal`)}
      ...
      <AllServicesGrid currentSlug="commercial-junk-removal" />

      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('commercial-junk-removal')}
        locations={getRelatedLocationsForService('commercial-junk-removal')}
        blogPosts={getRelatedBlogPostsForService('commercial-junk-removal')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('commercial-junk-removal')}
