...
const service = getServiceDetail('kitchen-demolition')!
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getCanonicalUrl('/services/kitchen-demolition')
  },
  openGraph: {
    title: `${service.title}`,
...
export default function ServicePage() {
  const internalLinks = getContextualLinks('service', '/services/kitchen-demolition')
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ServiceSchema
        name={service.title}
        description={service.description}
        url="/services/kitchen-demolition"
      />
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href={getSMSLink(PHONE_NUMBER, `Hi, I need a quote for kitchen demolition`)}
      ...
      <AllServicesGrid currentSlug="kitchen-demolition" />

      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('kitchen-demolition')}
        locations={getRelatedLocationsForService('kitchen-demolition')}
        blogPosts={getRelatedBlogPostsForService('kitchen-demolition')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('kitchen-demolition')}
