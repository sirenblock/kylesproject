...
const service = getServiceDetail('office-furniture')!

export const metadata: Metadata = {
  title: `${service.title} | 30A Junk Removal | Same-Day Service`,
  description: service.description,
  alternates: {
    canonical: getCanonicalUrl('/services/office-furniture')
  },
  openGraph: {
...
export default function ServicePage() {
  const internalLinks = getContextualLinks('service', '/services/office-furniture')
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('office-furniture')}
        locations={getRelatedLocationsForService('office-furniture')}
        blogPosts={getRelatedBlogPostsForService('office-furniture')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('office-furniture')}
