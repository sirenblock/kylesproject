...
const service = getServiceDetail('tv-electronics-recycling')!

export const metadata: Metadata = {
  title: `${service.title} — Same-Day Service`,
  ...
  alternates: {
    canonical: getCanonicalUrl('/services/tv-electronics-recycling')
  },
  openGraph: {
    title: `${service.title}`,
...
export default function ServicePage() {
  const internalLinks = getContextualLinks('service', '/services/tv-electronics-recycling')
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ServiceSchema
        name={service.title}
        description={service.description}
        url="/services/tv-electronics-recycling"
      />
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href={getSMSLink(PHONE_NUMBER, `Hi, I need a quote for electronics recycling`)}
      ...
      <AllServicesGrid currentSlug="tv-electronics-recycling" />

      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('tv-electronics-recycling')}
        locations={getRelatedLocationsForService('tv-electronics-recycling')}
        blogPosts={getRelatedBlogPostsForService('tv-electronics-recycling')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('tv-electronics-recycling')}
        title="Helpful Resources"
        subtitle="Official guidelines and resources from government agencies and nonprofits"
      />
