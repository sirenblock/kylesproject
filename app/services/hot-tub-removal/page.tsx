...
const service = getServiceDetail('hot-tub-removal')!
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getCanonicalUrl('/services/hot-tub-removal')
  },
  openGraph: {
    title: `${service.title}`,
...
export default function ServicePage() {
  ...
  const internalLinks = getContextualLinks('service', '/services/hot-tub-removal')
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* QuickQuoteForm -- embedded conversion surface for high-ticket service */}
      <section className="py-16 bg-white border-y border-slate-100">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-2">
              Get an Instant Hot Tub Removal Quote
            </h2>
      ...
      <AllServicesGrid currentSlug="hot-tub-removal" />

      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('hot-tub-removal')}
        locations={getRelatedLocationsForService('hot-tub-removal')}
        blogPosts={getRelatedBlogPostsForService('hot-tub-removal')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('hot-tub-removal')}
