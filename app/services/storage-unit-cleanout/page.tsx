...
export default function ServicePage() {
  const internalLinks = getContextualLinks('service', '/services/storage-unit-cleanout')
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ServiceSchema
        name={service.title}
        description={service.description}
        url="/services/storage-unit-cleanout"
      />
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href={getSMSLink(PHONE_NUMBER, `Hi, I need a quote for storage unit cleanout`)}
      ...
      <AllServicesGrid currentSlug="storage-unit-cleanout" />

      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('storage-unit-cleanout')}
        locations={getRelatedLocationsForService('storage-unit-cleanout')}
        blogPosts={getRelatedBlogPostsForService('storage-unit-cleanout')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('storage-unit-cleanout')}
