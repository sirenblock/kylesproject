...
const service = getServiceDetail('vacation-rentals')!

export const metadata: Metadata = {
  title: `${service.title} | 30A Junk Removal | Same-Day Service`,
  description: service.description,
  alternates: {
    canonical: getCanonicalUrl('/services/vacation-rentals')
  },
  openGraph: {
...
export default function ServicePage() {
  const internalLinks = getContextualLinks('service', '/services/vacation-rentals')
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('vacation-rentals')}
        locations={getRelatedLocationsForService('vacation-rentals')}
        blogPosts={getRelatedBlogPostsForService('vacation-rentals')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('vacation-rentals')}
