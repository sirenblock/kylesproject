...
const service = getServiceDetail('construction-debris')!

export const metadata: Metadata = {
  title: `${service.title} | 30A Junk Removal | Same-Day Service`,
  description: service.description,
  alternates: {
    canonical: getCanonicalUrl('/services/construction-debris')
  },
  openGraph: {
...
export default function ServicePage() {
  const internalLinks = getContextualLinks('service', '/services/construction-debris')
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <section className="relative -mt-16 pt-32 pb-20 bg-gradient-to-br from-ocean-600 via-ocean-700 to-slate-800 text-white overflow-hidden">
      ...
      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('construction-debris')}
        locations={getRelatedLocationsForService('construction-debris')}
        blogPosts={getRelatedBlogPostsForService('construction-debris')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('construction-debris')}
