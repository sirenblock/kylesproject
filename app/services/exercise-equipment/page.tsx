...
const service = getServiceDetail('exercise-equipment')!
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getCanonicalUrl('/services/exercise-equipment')
  },
  openGraph: {
    title: `${service.title}`,
...
export default function ServicePage() {
  const internalLinks = getContextualLinks('service', '/services/exercise-equipment')
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ServiceSchema
        name={service.title}
        description={service.description}
        url="/services/exercise-equipment"
      />
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href={getSMSLink(PHONE_NUMBER, `Hi, I need a quote for exercise equipment removal`)}
      ...
      <AllServicesGrid currentSlug="exercise-equipment" />

      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('exercise-equipment')}
        locations={getRelatedLocationsForService('exercise-equipment')}
        blogPosts={getRelatedBlogPostsForService('exercise-equipment')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('exercise-equipment')}
