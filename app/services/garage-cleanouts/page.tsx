...
const service = getServiceDetail('garage-cleanouts')!
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getCanonicalUrl('/services/garage-cleanouts')
  },
  openGraph: {
    title: `${service.title}`,
...
export default function ServicePage() {
  const internalLinks = getContextualLinks('service', '/services/garage-cleanouts')
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-2">
              Get an Instant Garage Cleanout Quote
            </h2>
      ...
      <AllServicesGrid currentSlug="garage-cleanouts" />

      {/* Related Content */}
      <RelatedContentGrid
        services={getRelatedServices('garage-cleanouts')}
        locations={getRelatedLocationsForService('garage-cleanouts')}
        blogPosts={getRelatedBlogPostsForService('garage-cleanouts')}
      />

      {/* Helpful External Resources */}
      <HelpfulResources
        links={getExternalLinksForService('garage-cleanouts')}
