...
function getLocationContext(locationSlug: string, locationName: string): string {
  const contexts: Record<string, string> = {
    ...
    'miramar-beach': `${locationName} is a popular beach community between Destin and Santa Rosa Beach, featuring a mix of vacation rentals, residential neighborhoods, and resort properties along the Emerald Coast.`,
    'sandestin': `${locationName} is one of the largest resort communities on the Emerald Coast, with over 2,400 acres of condominiums, villas, townhomes, and single-family residences requiring professional property maintenance.`,
    'dune-allen-beach': `${locationName} is a quiet, established beach community along 30A featuring a mix of vacation homes and year-round residences with stunning Gulf views and a relaxed coastal atmosphere.`,
    'point-washington': `${locationName} is an inland community near Point Washington State Forest, offering a more rural, spacious lifestyle with larger lots and a connection to the natural beauty of Walton County.`,
    'watersound': `${locationName} is an upscale planned community featuring luxury homes, extensive nature trails, and a growing collection of residential neighborhoods from WaterSound Origins to WaterSound West Beach.`,
    'seacrest-beach': `${locationName} is a vibrant beach community near Rosemary Beach known for its distinctive sky pool, diverse vacation rentals, and family-friendly atmosphere along the 30A corridor.`,
    'freeport': `${locationName} is a growing inland community in Walton County situated along the Choctawhatchee Bay, offering affordable residential options and convenient access to the 30A beach communities.`,
    'defuniak-springs': `${locationName} is the county seat of Walton County, known for its perfectly round spring-fed lake, historic architecture, and charming small-town character in Northwest Florida.`,
    'watersound-beach': `${locationName} is a beachfront community at the eastern end of 30A featuring luxury vacation rentals and homes with direct Gulf access and proximity to Panama City Beach.`,
    'panama-city': `${locationName} is the Bay County seat and a growing urban center offering diverse residential neighborhoods, a revitalized downtown, and extensive commercial districts.`,
    'lynn-haven': `${locationName} is a family-friendly suburb north of Panama City known for its excellent schools, parks, and growing residential communities in Bay County.`,
    'callaway': `${locationName} is a residential community east of Panama City offering affordable housing and a small-town atmosphere with convenient access to Bay County amenities.`,
    'springfield': `${locationName} is a small city within Bay County undergoing revitalization and rebuilding, with a growing community of homeowners and new construction projects.`,
    'parker': `${locationName} is a small waterfront city on St. Andrew Bay offering a quiet residential atmosphere with bay views and easy access to Panama City Beach.`,
    'laguna-beach': `${locationName} is an unincorporated beach community between Panama City Beach and the 30A corridor, offering a quieter alternative to the larger beach towns.`,
    'mexico-beach': `${locationName} is a small beach town actively rebuilding after Hurricane Michael, with a strong community spirit and growing demand for construction and cleanup services.`,
    'fort-walton-beach': `${locationName} is the largest city in Okaloosa County, featuring a vibrant waterfront downtown, military community near Eglin AFB, and diverse residential neighborhoods.`,
    'niceville': `${locationName} is a family-friendly city on the shores of Choctawhatchee Bay, known for its excellent schools, Northwest Florida State College, and high quality of life.`,
    'crestview': `${locationName} is the county seat of Okaloosa County and its largest city by area, experiencing rapid residential growth driven by its proximity to Eglin Air Force Base.`,
    'mary-esther': `${locationName} is a small city near Hurlburt Field in Okaloosa County, offering a tight-knit military community atmosphere with convenient access to Emerald Coast amenities.`,
    'shalimar': `${locationName} is a residential community on the shores of Choctawhatchee Bay in Okaloosa County, known for its waterfront living and proximity to military installations.`,
    'valparaiso': `${locationName} is a small city adjacent to Eglin Air Force Base in Okaloosa County, offering a close-knit community atmosphere with easy access to both bay and Gulf activities.`,
